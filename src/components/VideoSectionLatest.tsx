...
export default function VideoSectionLatest() {
    ...
    return (
        <div className="flex justify-center bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl shadow-lg -mt-[4.2rem] relative mx-1">
            ...
            <div className="w-[90%] p-3 flex flex-col justify-center items-center gap-3">
                <h3 className={`${language === "my" ? "text-base" : "text-lg"} font-bold bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent leading-tight pt-2 px-1`}>
                    {t.aboutBidBlast}
                </h3>
