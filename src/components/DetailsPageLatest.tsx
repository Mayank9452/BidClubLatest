...
export default function DetailsPageLatest() {
        ...
        <div className="min-h-screen">
            ...
            <div className="min-h-screen mx-2">
                ...
                <div className="max-w-md mx-auto pt-2 space-y-4 -mt-12">
                    ...
                    {/* Combined Video & Welcome Card - Replicating VideoSection.tsx */}
                    <div className="flex justify-center items-center bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl shadow-lg relative mx-2 p-2 gap-2">
                        {/* <div className="w-[58%]">
                            <video
                        ...
                        <div className="w-[90%] p-2 flex flex-col justify-center items-center gap-2">
                            <h3 className={`${language === "my" ? "text-base" : "text-lg"} font-bold bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent leading-tight text-center`}>
                                {t.welcomeToBidBlast}
                            </h3>
