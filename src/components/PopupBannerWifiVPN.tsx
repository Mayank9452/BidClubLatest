...
import { X, WifiOff, Sparkles } from "lucide-react";
import { AnimatePresence, motion } from "framer-motion";
import { Button } from "./ui/button";
import { useLanguage } from "./context/LanguageContext";

interface PopupBannerWifiVPNProps {
  isShow: boolean;
  onClose: () => void;
}

const PopupBannerWifiVPN: React.FC<PopupBannerWifiVPNProps> = ({
  isShow,
  onClose,
}) => {
  const { t } = useLanguage();
...
export default PopupBannerWifiVPN;
