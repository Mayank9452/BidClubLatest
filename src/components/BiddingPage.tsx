...
export default function BiddingPage() {
  ...
  const filledSetsData: { [key: string]: string[] } = {
    "0": ["553", "995", "4", "39", "351", "83"],
    "1": ["583", "9005", "49", "34", "251", "86"],
    "2": ["543", "895", "56", "47", "35", "8"],
  };
          ...
          <div className="">
            <div className="max-w-md mx-auto space-y-6">
                ...
                {isShowingFilledSets && (
                  ...
                  >
                    <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 px-1 scrollbar-hide">
                      {Object.entries(filledSetsData).map(([setIndex, setNumbers]) => (
                        <div
                          key={setIndex}
                          className="min-w-[80%] flex-shrink-0 snap-center relative"
                        >
                            ...
                            <div className="border-2 border-dashed border-white/60 rounded-xl p-3">
                              ...
                              <div className="flex items-center justify-center gap-2 w-[70%] mx-auto relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500 to-[#fd0075] p-1.5 shadow-lg mb-4 backdrop-blur-2xl">
                                ...
                                <h3 className="text-[12px] font-bold text-white tracking-[1px]">
                                  {t.setNumbersTitle.replace("{0}", String(parseInt(setIndex) + 1))}
                                </h3>
                              </div>
              ...
              <motion.button
                ...
                className={`w-full mx-auto py-5 rounded-[1.75rem] font-black text-sm tracking-[3px]  shadow-2xl transition-all flex items-center justify-center gap-3 rounded-xl 
